...
const inventors = [
    ...
    { first: 'Galieo', last: 'Galilei', year: 1564, passed: 1642 },
    ...
    { first: 'Lise', last: 'Goode', year: 1855, passed: 1905 },
...
const people = [
    ...
    'Berio, Luciano', 'Berle, Milton', 'Berline, Irving', 'Berne, Eric',
    'Bernhard, Sandra', 'Berra, Yogi', 'Berry, Halle', 'Berry, Wendell',
    'Bethea, Erin', 'Bevan, Aneurin', 'Bevel, Ken', 'Biden, Joseph',
    'Bierce, Ambrose', 'Biko, Steve', 'Billings, Josh', 'Biondo, Frank',
    'Birrell, Augustine', 'Black, Elk', 'Blair, Robert', 'Blaire, Tony',
    'Blake, William',
];
...
// Array.prototype.map()
// 2. Give us an array of the invenstor's first and last names
...
// 4. How may years did all the inventors live?
